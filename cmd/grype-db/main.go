...
import (
	...
	"github.com/nextlinux/vulnersdb/cmd/vulnersdb/cli"
...
func main() {
	...
	// note: it is important to always do signal handling from the main package. In this way if vulnersdb is used
