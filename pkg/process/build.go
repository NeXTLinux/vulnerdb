...
import (
	...
	v1 "github.com/nextlinux/vulnersdb/pkg/process/v1"
	v2 "github.com/nextlinux/vulnersdb/pkg/process/v2"
	v3 "github.com/nextlinux/vulnersdb/pkg/process/v3"
	v4 "github.com/nextlinux/vulnersdb/pkg/process/v4"
	v5 "github.com/nextlinux/vulnersdb/pkg/process/v5"
	"github.com/nextlinux/vulnersdb/pkg/provider"
	"github.com/nextlinux/vulnersdb/pkg/provider/entry"
	"github.com/nextlinux/vulnersdb/pkg/provider/unmarshal"
	grypeDBv1 "github.com/nextlinux/grype/grype/db/v1"
	grypeDBv2 "github.com/nextlinux/grype/grype/db/v2"
	grypeDBv3 "github.com/nextlinux/grype/grype/db/v3"
	grypeDBv4 "github.com/nextlinux/grype/grype/db/v4"
	grypeDBv5 "github.com/nextlinux/grype/grype/db/v5"
)
