...
import (
	...
	"github.com/nextlinux/vulnersdb/internal/file"
	"github.com/nextlinux/vulnersdb/internal/log"
	"github.com/nextlinux/vulnersdb/pkg/data"
	"github.com/nextlinux/grype/grype/db"
	grypeDB "github.com/nextlinux/grype/grype/db/v1"
	grypeDBStore "github.com/nextlinux/grype/grype/db/v1/store"
)
...
func normalizeSeverity(metadata *grypeDB.VulnerabilityMetadata, reader grypeDB.VulnerabilityMetadataStoreReader) {
	...
	if strings.Contains(metadata.RecordSource, grypeDB.NVDNamespace) {
		return
	}
