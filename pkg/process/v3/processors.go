...
import (
	...
	"github.com/nextlinux/vulnersdb/pkg/process/v3/transformers/github"
	"github.com/nextlinux/vulnersdb/pkg/process/v3/transformers/msrc"
	"github.com/nextlinux/vulnersdb/pkg/process/v3/transformers/nvd"
	"github.com/nextlinux/vulnersdb/pkg/process/v3/transformers/os"
)
