...
import (
	...
	"github.com/nextlinux/vulnersdb/pkg/provider/unmarshal/nvd/cvss20"
	"github.com/nextlinux/vulnersdb/pkg/provider/unmarshal/nvd/cvss30"
	"github.com/nextlinux/vulnersdb/pkg/provider/unmarshal/nvd/cvss31"
)
...
// this is the struct to use when unmarshalling directly from the API (which vulnersdb is NOT doing)
